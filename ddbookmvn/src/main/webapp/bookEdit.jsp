					...
					<div class="card-header">
						...
						<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputabout" placeholder="作者" name="about" value="<%=book.getAbout()%>>">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputdate" placeholder="出版日期" name="c_date" value="<%=book.getC_date()%>>">
								</div>
							</div>
							<div class="form-group row">
								<label for="inputbrief" class="col-sm-2 col-form-label text-right">简介:</label>
								<div class="col-sm-10">
									<textarea class="form-control" id="inputbrief" placeholder="简介" name="brief"><%=book.getBrief()%></textarea>
								</div>
							</div>
							<div class="form-group row">
